      ...
      // Manejo de Propiedades OnSubmit
        ...
        // Llena el Formulario de propiedad seleccionada
              const selectProduct = (currentProperty) => {
                editStatus = true;
                property.selectTP = currentProperty.selectTP
...
<!-- *- L A Y O U T  -->
  <!-- *- SELECCION DE CARACTERISÍSTICAS PARA BUSQUEDA DE PROPIEDADES ""propFilter""-->
      ...
      <!-- Tipo de Operación -->
            <select class="selTO" id="selTO" name="selTO" bind:value={property.selecTO}>
      ...
      <!-- Seleccion y Botones -->
          <div class="desFind">
          <p>
            {property.selectTP} en {property.selecTO} en {rangeProp} rango de precio, con {numBeds} recámaras{numBaths}
                    ...
                    <section on:click={selectProduct(property)} class="book "
                      ...
                      <section class="book-top-info" >
                        <figure class="bkcont" >
                          ...
                          <figcaption>{property.claveEB}</figcaption>
                        </figure>
                      </section> 
                ...
                {#if systStatus === "start"}
                  ...
                  <section on:click={selectProduct(property)} class="book "
                    ...
                    <section class="book-top-info" >
                      <figure class="bkcont" >
                        <img src={property.urlImage} alt={property.nameProperty} class="bkcover" >
                        <div class="language">{property.claveEB}</div>
              ...
              <div class="container">
                <div class="form-group row">
                  <div class="col">
                       ...
                       <select class="selTP" id="selTP" name="selTP" bind:value={property.selectTP} required>
                        <option disabled selected value="">Tipo de Propiedad</option>
                        {#each typeProperties as typeProperty}
                            <option type="checkbox" value={typeProperty}
                              >{typeProperty}</option>
